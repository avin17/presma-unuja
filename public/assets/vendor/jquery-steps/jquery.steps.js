    ...
    function renderPagination(wizard, options, state) {
        if (options.enablePagination) {
            var pagination =
                ...
                buttonFinish =
                '<li><a href="#{0}" onclick="$(wizard_with_validation).submit()" role="menuitem">{1}</a></li>',
                buttons = "";
            ...
            if (options.enableFinishButton) {
                buttons += buttonFinish.format("finish", options.labels.finish);
                // buttons += buttonFinish.format("finish", options.labels.fi);
            }
